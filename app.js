//element variables
let investmentValue = document.getElementById("investmentValue");
let interestValue = document.getElementById("interestValue");
let yearValue = document.getElementById("yearValue");

let investmentSlider = document.getElementById("investmentSlider");
let interestSlider = document.getElementById("interestSlider");
let yearSlider = document.getElementById("yearSlider");

let final_table = document.getElementById("final_table");
